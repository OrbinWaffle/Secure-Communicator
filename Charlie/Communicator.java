...
public class Communicator {
	...
	public static void SendMessage(String recipient)
	{
		...
		byte[] mac = MAC.GenerateMAC(encryptedData, aesKey);

		DP packet = new DP(encryptedData, encryptedKey, mac);
	...
	public static void ReceiveMessage()
	{
		...
		if(!MAC.VerifyMAC(encryptedData, decryptedAESKey, mac)) {
			System.out.println("Message could not be authenticated.");
			System.exit(0);
		}
